var deviceReady = jQuery.Deferred();
...
FallingBlocks.View1 = function(params) {
    ...
    viewModel = $.extend(viewModel, {
        ...
        viewShown: function () {
            ...
            function onSuccess(acceleration) {
                if (accelerometer()) {
                    if (acceleration.x < -1) leftClicked();
                    if (acceleration.x > 1) rightClicked();
                }
                setTimeout(getCurrentAcceleration, 100);
            }
            ...
            deviceReady.then(getCurrentAcceleration);
    ...
    var help = "Finish twenty lines and you progress to a new level. Try rotating bombs to different shapes.  You can redefine the keys before you press 'Start'.  Press 'p' to pause.";
