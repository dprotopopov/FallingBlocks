...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(FallingBlocks.config.endpoints);

    var serviceConfig = $.extend(true, {}, FallingBlocks.config.services, {
        db: {
    ...
    FallingBlocks.db = new DevExpress.data.ODataContext(serviceConfig.db);
